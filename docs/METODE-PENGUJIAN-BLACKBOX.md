...
#### **H. Modul Pengaturan Toko (Shop Setting - Hanya Owner)**
| ID | Fitur | Aktor | Skenario Pengujian | Input (Data) | Hasil yang Diharapkan | Status |
|:---|:---|:---:|:---|:---|:---|:---:|
| SHOP-01 | Lihat Pengaturan | Owner | Membuka halaman pengaturan toko | Klik menu Pengaturan Toko | Menampilkan data toko saat ini (Nama, Alamat, Tax, dll) | Sukses |
| SHOP-02 | Update Info Dasar | Owner | Mengubah identitas toko | Nama Toko, Alamat, Email, No. Telp, NPWP | Data identitas toko terupdate di database & header struk | Sukses |
| SHOP-03 | Upload Logo & QRIS | Owner | Mengganti logo toko & QRIS statis | File Gambar (PNG/JPG) | Logo & QRIS terupdate dan muncul di halaman terkait | Sukses |
| SHOP-04 | Pengaturan Pajak | Owner | Mengubah persentase pajak (PPN) | Nilai Pajak (Misal: 12) | Kalkulasi total di POS berubah sesuai rate pajak baru | Sukses |
| SHOP-05 | Format Struk | Owner | Mengubah footer & ukuran kertas | Footer Text, Pilih Ukuran (58mm/80mm) | Tampilan struk PDF menyesuaikan dengan pengaturan baru | Sukses |
| SHOP-06 | Validasi Input | Owner | Mengosongkan field wajib | Nama Toko: (Kosong), Pajak: (Kosong) | Muncul pesan error validasi pada field terkait | Sukses |
...
Pada **Pengaturan Toko**, Owner memiliki fleksibilitas penuh untuk menyesuaikan identitas bisnis, mulai dari logo hingga kebijakan pajak. Integrasi pengaturan ini dengan modul lain (seperti POS dan Struk) terbukti sinkron secara otomatis.
...
1.  **Poin Kekuatan (Strengths):**
    ...
    *   **Konfigurasi Dinamis:** Fitur Shop Setting memungkinkan aplikasi digunakan oleh berbagai jenis toko tanpa perlu perubahan kode (Customizable).
