        ...
        <header className="fixed top-0 left-0 right-0 z-50 flex justify-center p-4">
            <nav className="flex w-full max-w-7xl items-center justify-between rounded-2xl border border-white/20 bg-white/60 px-6 py-3 backdrop-blur-xl dark:border-white/10 dark:bg-black/40">
                <Link href="/" className="flex items-center gap-2">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-600/10 p-1 dark:bg-indigo-400/10">
                ...
                <div className="flex items-center gap-4">
                    {auth?.user ? (
                        <Button asChild variant="default" className="rounded-xl shadow-lg shadow-indigo-500/20">
                        ...
                        <>
                            ...
                            <Button asChild variant="default" className="rounded-xl bg-indigo-600 shadow-lg shadow-indigo-500/20 hover:bg-indigo-700">
